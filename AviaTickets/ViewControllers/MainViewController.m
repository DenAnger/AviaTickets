...
- (void)viewDidLoad {
    ...
    _departureButton.frame = CGRectMake(30.0, 150.0, [UIScreen mainScreen].bounds.size.width - 60.0, 60.0);
    [_departureButton.layer setCornerRadius:6.0];
    _departureButton.backgroundColor = [[UIColor redColor] colorWithAlphaComponent:0.3];
    ...
    [_arrivalButton.layer setCornerRadius:6.0];
    _arrivalButton.backgroundColor = [[UIColor redColor] colorWithAlphaComponent:0.3];
